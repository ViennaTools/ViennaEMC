...
This file shows the results of the example "bulkSimulation".

Note: To use this file you have to install emcPlottingFiles. For 
instructions on how to do that look at the main README.md.

To use this file, run the example "bulkSimulation", then adapt the
...
prefix = "bulkSimulation"   # file name prefix
...
appliedField = 10e5   # electric field [V / m] (adapt if needed)
